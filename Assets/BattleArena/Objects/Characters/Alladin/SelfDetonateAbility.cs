...
{
    public class SelfDetonateAbility : Ability
    {
        [SerializeField]
        ...
        protected override void OnExecution()
        {
            ...
            anim.state.SetAnimation(0, "bomb_throw_only", false);
            anim.state.Complete += State_Complete;
            var projectile = AttackerSpawner.SpawnAttacker(m_projectile, m_owner);
            projectile.GetComponent<SelfBombDamageCollider>().SetOwner(m_owner);
